...
public class BankDeposit {
    public static void main(String[] args) {
        ...
        if (!(clientCountry.equals("Россия"))) {
            ...
            System.out.println("Вы не можете открыть счет в нашем банке.");
            System.out.println("Наш банк принимает заявление на открытие счета, только от лиц достигших 18 лет.");
        } else if (!(currency.equals("руб."))) {
            System.out.println("Вы не можете открыть счет в нашем банке.");
